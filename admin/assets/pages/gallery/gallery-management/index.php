<div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
    <h6 class="fw-semibold mb-0">All Images</h6>
    <ul class="d-flex align-items-center gap-2">
        ...
        <li>/</li>
        <li class="fw-medium">Gallery Management</li>
    </ul>
</div>
...
<div class="card basic-data-table">
    <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <a href="<?= get_site_option('dashboard_url') ?>?page=add-gallery-image" class="btn btn-primary d-inline-flex align-items-center gap-2">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table bordered-table mb-0" id="membersDataTable" data-page-length='25'>
                ...
                <tbody>
                    <?= load_gallery('gallery-management') ?>
                </tbody>
            </table>
        </div>
    </div>
