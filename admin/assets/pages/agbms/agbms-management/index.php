<div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
    <h6 class="fw-semibold mb-0">All AGBMs</h6>
    <ul class="d-flex align-items-center gap-2">
        ...
        <li>/</li>
        <li class="fw-medium">AGBMs Management</li>
    </ul>
</div>

<div class="card basic-data-table">
    <div class="card-header d-flex align-items-center justify-content-between">
        <h5 class="card-title mb-0">All Annual General Body Meetings</h5>
        <a href="<?= get_site_option('dashboard_url') ?>?page=add-agbm" class="btn btn-primary d-inline-flex align-items-center gap-2">
            <iconify-icon icon="mage:megaphone-b" class="icon text-lg"></iconify-icon>
            Add New AGBM
        </a>
    </div>
    <div class="card-body">
        <table class="table bordered-table mb-0" id="agbmsDataTable" data-page-length='25'>
            <thead>
                <tr>
            ...
            <tbody>
                <?= fetch_agbm('agbms-management', 'published', 'agbm_id', 'DESC') ?>
            </tbody>
        </table>
    </div>
</div>
