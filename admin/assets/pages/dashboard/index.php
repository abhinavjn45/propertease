                    ...
                    <div class="card-body p-0">
                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-1 mb-8">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <div>
                                    <span class="mb-2 fw-medium text-secondary-light text-sm">Total Members</span>
                                    <h6 class="fw-semibold"><?= get_total_numbers('members') ?></h6>
                                </div>
                            </div>
                ...
                <div class="card p-3 shadow-2 radius-8 border input-form-light h-100 bg-gradient-end-2">
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-between gap-1 mb-8">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div>
                            <span class="mb-2 fw-medium text-secondary-light text-sm">Active Members</span>
                            <h6 class="fw-semibold"><?= get_total_numbers('members', 'member_status', 'active') ?></h6>
                            </div>
                        </div>
